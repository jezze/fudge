...
$GCC $GCCFLAGS $DIR_SOURCE_KERNEL/elf.c -o $DIR_SOURCE_KERNEL/elf.o
...
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/ata.c -o $DIR_SOURCE_ARCH_KERNEL/ata.o
...
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/kbd.c -o $DIR_SOURCE_ARCH_KERNEL/kbd.o
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/mmu.c -o $DIR_SOURCE_ARCH_KERNEL/mmu.o
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/pit.c -o $DIR_SOURCE_ARCH_KERNEL/pit.o
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/rtc.c -o $DIR_SOURCE_ARCH_KERNEL/rtc.o
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/syscall.c -o $DIR_SOURCE_ARCH_KERNEL/syscall.o
$GCC $GCCFLAGS $DIR_SOURCE_ARCH_KERNEL/vga.c -o $DIR_SOURCE_ARCH_KERNEL/vga.o
$GCC $GCCFLAGS $DIR_SOURCE_LIB/assert.c -o $DIR_SOURCE_LIB/assert.o
...
$GCC $GCCFLAGS $DIR_SOURCE_LIB/vfs.c -o $DIR_SOURCE_LIB/vfs.o
...
$LD $LDFLAGS \
    ...
    $DIR_SOURCE_ARCH_KERNEL/kbd.o \
    $DIR_SOURCE_ARCH_KERNEL/mmu.o \
    $DIR_SOURCE_ARCH_KERNEL/pit.o \
    $DIR_SOURCE_ARCH_KERNEL/rtc.o \
    $DIR_SOURCE_ARCH_KERNEL/syscall.o \
    $DIR_SOURCE_ARCH_KERNEL/vga.o \
    $DIR_SOURCE_LIB/assert.o \
...
$LD $LDFLAGS $DIR_SOURCE_BIN/cat.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/cat

$GCC $GCCFLAGS $DIR_SOURCE_BIN/cd.c -o $DIR_SOURCE_BIN/cd.o
$LD $LDFLAGS $DIR_SOURCE_BIN/cd.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/cd

$GCC $GCCFLAGS $DIR_SOURCE_BIN/clear.c -o $DIR_SOURCE_BIN/clear.o
$LD $LDFLAGS $DIR_SOURCE_BIN/clear.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/clear

$ASM $ASMFLAGS $DIR_SOURCE_BIN/cpu.s -o $DIR_SOURCE_BIN/cpus.o
$GCC $GCCFLAGS $DIR_SOURCE_BIN/cpu.c -o $DIR_SOURCE_BIN/cpu.o
$LD $LDFLAGS $DIR_SOURCE_BIN/cpu.o $DIR_SOURCE_BIN/cpus.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/cpu

$GCC $GCCFLAGS $DIR_SOURCE_BIN/date.c -o $DIR_SOURCE_BIN/date.o
$LD $LDFLAGS $DIR_SOURCE_BIN/date.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/date

$GCC $GCCFLAGS $DIR_SOURCE_BIN/echo.c -o $DIR_SOURCE_BIN/echo.o
$LD $LDFLAGS $DIR_SOURCE_BIN/echo.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/echo

$GCC $GCCFLAGS $DIR_SOURCE_BIN/elf.c -o $DIR_SOURCE_BIN/elf.o
$LD $LDFLAGS $DIR_SOURCE_BIN/elf.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/elf

$GCC $GCCFLAGS $DIR_SOURCE_BIN/hello.c -o $DIR_SOURCE_BIN/hello.o
$LD $LDFLAGS $DIR_SOURCE_BIN/hello.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/hello

$GCC $GCCFLAGS $DIR_SOURCE_BIN/ls.c -o $DIR_SOURCE_BIN/ls.o
$LD $LDFLAGS $DIR_SOURCE_BIN/ls.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/ls

$GCC $GCCFLAGS $DIR_SOURCE_BIN/reboot.c -o $DIR_SOURCE_BIN/reboot.o
$LD $LDFLAGS $DIR_SOURCE_BIN/reboot.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/reboot

$GCC $GCCFLAGS $DIR_SOURCE_BIN/timer.c -o $DIR_SOURCE_BIN/timer.o
$LD $LDFLAGS $DIR_SOURCE_BIN/timer.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/timer

$GCC $GCCFLAGS $DIR_SOURCE_BIN/vga.c -o $DIR_SOURCE_BIN/vga.o
$LD $LDFLAGS $DIR_SOURCE_BIN/vga.o $DIR_SOURCE_LIB/memory.o $DIR_SOURCE_LIB/session.o $DIR_SOURCE_LIB/string.o $DIR_SOURCE_LIB/vfs.o $DIR_SOURCE_LIB/file.o $DIR_SOURCE_ARCH_LIB/calls.o -o $DIR_IMAGE_BIN/vga
