...
$LD $LDFLAGS $DIR_RAMDISK/cpu.o $DIR_RAMDISK/cpus.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/cpu

$GCC $GCCFLAGS $DIR_RAMDISK/date.c -o $DIR_RAMDISK/date.o
$LD $LDFLAGS $DIR_RAMDISK/date.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/date

$GCC $GCCFLAGS $DIR_RAMDISK/echo.c -o $DIR_RAMDISK/echo.o
$LD $LDFLAGS $DIR_RAMDISK/echo.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/echo

$GCC $GCCFLAGS $DIR_RAMDISK/elf.c -o $DIR_RAMDISK/elf.o
$LD $LDFLAGS $DIR_RAMDISK/elf.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/elf

$GCC $GCCFLAGS $DIR_RAMDISK/hello.c -o $DIR_RAMDISK/hello.o
$LD $LDFLAGS $DIR_RAMDISK/hello.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/hello

$GCC $GCCFLAGS $DIR_RAMDISK/ls.c -o $DIR_RAMDISK/ls.o
$LD $LDFLAGS $DIR_RAMDISK/ls.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/ls

$GCC $GCCFLAGS $DIR_RAMDISK/reboot.c -o $DIR_RAMDISK/reboot.o
$LD $LDFLAGS $DIR_RAMDISK/reboot.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/reboot

$GCC $GCCFLAGS $DIR_RAMDISK/timer.c -o $DIR_RAMDISK/timer.o
$LD $LDFLAGS $DIR_RAMDISK/timer.o $DIR_LIB/memory.o $DIR_LIB/string.o $DIR_LIB/vfs.o $DIR_LIB/file.o $DIR_ARCH_LIB/calls.o -o $DIR_RAMDISK/timer
