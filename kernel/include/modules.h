...
union modules_module
{
    ...
    struct modules_filesystem
    {
        ...
        unsigned int (*parent)(struct modules_filesystem *self, unsigned int id);
        unsigned int (*walk)(struct modules_filesystem *self, unsigned int id, unsigned int count, void *buffer);
