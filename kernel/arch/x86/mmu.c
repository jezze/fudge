...
void mmu_init()
{
    ...
    mmu_map(&mmuKernelDirectory, &mmuUserTable, (void *)0x00400000, (void *)0x00400000, 0x00400000, MMU_TABLE_FLAG_PRESENT | MMU_TABLE_FLAG_WRITEABLE, MMU_PAGE_FLAG_PRESENT | MMU_PAGE_FLAG_WRITEABLE);
