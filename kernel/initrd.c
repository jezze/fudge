...
void initrd_init(unsigned int initrdc, void **initrdv)
{
    ...
    vfs_filesystem_init(&filesystem, "/ramdisk", 0, 0, initrd_filesystem_read, 0, initrd_filesystem_get_name, initrd_filesystem_find, initrd_filesystem_walk, initrd_filesystem_get_physical);
