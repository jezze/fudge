...
void apic_test(void);
void apic_isr00(void);
void apic_isr01(void);
void apic_isr02(void);
void apic_isr03(void);
void apic_isr04(void);
void apic_isr05(void);
void apic_isr06(void);
void apic_isr07(void);
void apic_isr08(void);
void apic_isr09(void);
void apic_isr0A(void);
void apic_isr0B(void);
void apic_isr0C(void);
void apic_isr0D(void);
void apic_isr0E(void);
void apic_isr0F(void);
