...
$(DIR_SRC)/modules/arch/x86/ata/ata.ko.0: $(DIR_SRC)/modules/arch/x86/ata/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/atapi/atapi.ko.0: $(DIR_SRC)/modules/arch/x86/atapi/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/bga/bga.ko.0: $(DIR_SRC)/modules/arch/x86/bga/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/cpuid/cpuid.ko: $(DIR_SRC)/modules/arch/x86/cpuid/main.o $(DIR_SRC)/modules/arch/x86/cpuid/cpuid.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/ehci/ehci.ko.0: $(DIR_SRC)/modules/arch/x86/ehci/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/fpu/fpu.ko: $(DIR_SRC)/modules/arch/x86/fpu/main.o $(DIR_SRC)/modules/arch/x86/fpu/fpu.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/i915/i915.ko.0: $(DIR_SRC)/modules/arch/x86/i915/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/ide/ide.ko: $(DIR_SRC)/modules/arch/x86/ide/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/io/io.ko: $(DIR_SRC)/modules/arch/x86/io/io.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/msr/msr.ko: $(DIR_SRC)/modules/arch/x86/msr/main.o $(DIR_SRC)/modules/arch/x86/msr/msr.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/ohci/ohci.ko.0: $(DIR_SRC)/modules/arch/x86/ohci/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/pci/pci.ko: $(DIR_SRC)/modules/arch/x86/pci/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/pic/pic.ko: $(DIR_SRC)/modules/arch/x86/pic/main.o $(DIR_SRC)/modules/arch/x86/pic/pic.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/pit/pit.ko.0: $(DIR_SRC)/modules/arch/x86/pit/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/platform/platform.ko: $(DIR_SRC)/modules/arch/x86/platform/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/ps2/ps2.ko: $(DIR_SRC)/modules/arch/x86/ps2/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/ps2keyboard/ps2keyboard.ko.0: $(DIR_SRC)/modules/arch/x86/ps2keyboard/main.o $(DEP_MOD)
$(DIR_SRC)/modules/arch/x86/ps2mouse/ps2mouse.ko.0: $(DIR_SRC)/modules/arch/x86/ps2mouse/main.o $(DEP_MOD)
...
$(DIR_SRC)/modules/arch/x86/virtio/virtio.ko.0: $(DIR_SRC)/modules/arch/x86/virtio/main.o $(DEP_MOD)
