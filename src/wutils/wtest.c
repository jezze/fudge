...
static void onwminit(unsigned int source, void *mdata, unsigned int msize)
{
    ...
    char *data =
        ...
        "        + textbutton id \"sweden\" in \"countrylist\" label \"Sweden\" fit \"1\"\n"
        "        + textbutton id \"norway\" in \"countrylist\" label \"Norway\" fit \"1\"\n"
        "        + textbutton id \"england\" in \"countrylist\" label \"England\" fit \"1\"\n"
