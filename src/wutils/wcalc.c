...
static void onwminit(unsigned int source, void *mdata, unsigned int msize)
{
    ...
    char *data =
        ...
        "      + button id \"button7\" in \"row1\" label \"7\" fit \"1\"\n"
        "      + button id \"button8\" in \"row1\" label \"8\" fit \"1\"\n"
        "      + button id \"button9\" in \"row1\" label \"9\" fit \"1\"\n"
        "      + button id \"button/\" in \"row1\" label \"/\" fit \"1\"\n"
        "    + layout id \"row2\" in \"base\" form \"horizontal\" padding \"8\"\n"
        "      + button id \"button4\" in \"row2\" label \"4\" fit \"1\"\n"
        "      + button id \"button5\" in \"row2\" label \"5\" fit \"1\"\n"
        "      + button id \"button6\" in \"row2\" label \"6\" fit \"1\"\n"
        "      + button id \"buttonx\" in \"row2\" label \"x\" fit \"1\"\n"
        "    + layout id \"row3\" in \"base\" form \"horizontal\" padding \"8\"\n"
        "      + button id \"button3\" in \"row3\" label \"3\" fit \"1\"\n"
        "      + button id \"button2\" in \"row3\" label \"2\" fit \"1\"\n"
        "      + button id \"button1\" in \"row3\" label \"1\" fit \"1\"\n"
        "      + button id \"button-\" in \"row3\" label \"-\" fit \"1\"\n"
        "    + layout id \"row4\" in \"base\" form \"horizontal\" padding \"8\"\n"
        "      + button id \"button0\" in \"row4\" label \"0\" fit \"1\"\n"
        "      + button id \"button.\" in \"row4\" label \".\" fit \"1\"\n"
        "      + button id \"button+\" in \"row4\" label \"+\" fit \"1\"\n"
        "      + button id \"button=\" in \"row4\" label \"=\" fit \"1\"\n";
