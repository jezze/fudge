...
static void onwminit(unsigned int source, void *mdata, unsigned int msize)
{
    ...
    char *data0 =
        ...
        "    + layout id \"container\" in \"base\" flow \"horizontal-stretch\" span \"1\"\n"
        "      + textbox id \"output\" in \"container\" mode \"readonly\" span \"1\"\n"
        "        + text id \"result\" in \"output\" content \"0\" halign \"right\"\n";
    char *data1 =
        "    + layout id \"row1\" in \"base\" flow \"horizontal-stretch\" span \"1\"\n"
        ...
        "    + layout id \"row2\" in \"base\" flow \"horizontal-stretch\" span \"1\"\n"
        ...
        "    + layout id \"row3\" in \"base\" flow \"horizontal-stretch\" span \"1\"\n"
        ...
        "    + layout id \"row4\" in \"base\" flow \"horizontal-stretch\" span \"1\"\n"
