...
static void onwminit(unsigned int source, void *mdata, unsigned int msize)
{
    ...
    char *data =
        ...
        "      + textbox id \"output\" in \"container\" mode \"readonly\" fit \"stretched\"\n"
        "        + text id \"result\" in \"output\" content \"0\" halign \"right\"\n"
        "    + grid id \"buttons\" in \"base\" columns \"4\" padding \"8\" fit \"stretched\"\n"
        "      + button id \"button7\" in \"buttons\" label \"7\" fit \"stretched\"\n"
        "      + button id \"button8\" in \"buttons\" label \"8\" fit \"stretched\"\n"
        "      + button id \"button9\" in \"buttons\" label \"9\" fit \"stretched\"\n"
        "      + button id \"button/\" in \"buttons\" label \"/\" fit \"stretched\"\n"
        "      + button id \"button4\" in \"buttons\" label \"4\" fit \"stretched\"\n"
        "      + button id \"button5\" in \"buttons\" label \"5\" fit \"stretched\"\n"
        "      + button id \"button6\" in \"buttons\" label \"6\" fit \"stretched\"\n"
        "      + button id \"buttonx\" in \"buttons\" label \"x\" fit \"stretched\"\n"
        "      + button id \"button3\" in \"buttons\" label \"3\" fit \"stretched\"\n"
        "      + button id \"button2\" in \"buttons\" label \"2\" fit \"stretched\"\n"
        "      + button id \"button1\" in \"buttons\" label \"1\" fit \"stretched\"\n"
        "      + button id \"button-\" in \"buttons\" label \"-\" fit \"stretched\"\n"
        "      + button id \"button0\" in \"buttons\" label \"0\" fit \"stretched\"\n"
        "      + button id \"button.\" in \"buttons\" label \".\" fit \"stretched\"\n"
        "      + button id \"button+\" in \"buttons\" label \"+\" fit \"stretched\"\n"
        "      + button id \"button=\" in \"buttons\" label \"=\" fit \"stretched\"\n";
