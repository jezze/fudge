...
unsigned int call_create(unsigned int descriptor, char *name, unsigned int count);
unsigned int call_destroy(unsigned int descriptor, char *name, unsigned int count);
...
unsigned int call_walk(unsigned int descriptor, unsigned int pdescriptor, char *path, unsigned int count);
