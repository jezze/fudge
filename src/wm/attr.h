...
#define ATTR_FIT                        5
#define ATTR_FORM                       6
#define ATTR_HALIGN                     7
#define ATTR_ID                         8
#define ATTR_IN                         9
#define ATTR_LABEL                      10
#define ATTR_MIMETYPE                   11
#define ATTR_MODE                       12
#define ATTR_ONCLICK                    13
#define ATTR_OVERFLOW                   14
#define ATTR_PADDING                    15
#define ATTR_SOURCE                     16
...
#define ATTR_FORM_DEFAULT               0
#define ATTR_FORM_HORIZONTAL            1
#define ATTR_FORM_HORIZONTALSTRETCH     2
#define ATTR_FORM_STRETCH               3
#define ATTR_FORM_VERTICAL              4
#define ATTR_FORM_VERTICALSTRETCH       5
