...
static void setupwidgets(void)
{
    ...
    char *data =
        ...
        "      + select id \"app-select\" in \"menu\" label \"APPS\"\n"
        "      + layout id \"app-layout\" in \"app-select\" flow \"vertical-stretch\"\n"
        "        + choice in \"app-layout\" label \"TERMINAL\" onclick \"run /bin/wshell\"\n"
        "        + choice in \"app-layout\" label \"FILE MANAGER\" onclick \"run /bin/wfile\"\n"
        "        + choice in \"app-layout\" label \"CALCULATOR\" onclick \"run /bin/wcalc\"\n"
        "        + choice in \"app-layout\" label \"TEST\" onclick \"run /bin/wtest\"\n"
