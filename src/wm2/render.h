...
#define RENDER_CHOICE_PADDING_WIDTH     40
#define RENDER_CHOICE_PADDING_HEIGHT    24
#define RENDER_SELECT_PADDING_WIDTH     40
#define RENDER_SELECT_PADDING_HEIGHT    24
