struct binary_format
{
    ...
    unsigned int (*match)(struct service_protocol *protocol, struct service_backend *backend, struct task *task, unsigned int descriptor, unsigned int id);
    unsigned long (*findsymbol)(struct service_protocol *protocol, struct service_backend *backend, struct task *task, unsigned int descriptor, unsigned int id, unsigned int count, char *symbol);
    unsigned long (*findentry)(struct service_protocol *protocol, struct service_backend *backend, struct task *task, unsigned int descriptor, unsigned int id);
    unsigned long (*findbase)(struct service_protocol *protocol, struct service_backend *backend, struct task *task, unsigned int descriptor, unsigned int id, unsigned long address);
    unsigned int (*copyprogram)(struct service_protocol *protocol, struct service_backend *backend, struct task *task, unsigned int descriptor, unsigned int id);
    unsigned int (*relocate)(struct service_protocol *protocol, struct service_backend *backend, struct task *task, unsigned int descriptor, unsigned int id, unsigned int address);
