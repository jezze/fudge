...
#define RESOURCE_TASKDESCRIPTOR         3
#define RESOURCE_SERVICEBACKEND         4
#define RESOURCE_SERVICEPROTOCOL        5
#define RESOURCE_SERVICECHANNEL         6
#define RESOURCE_BINARYFORMAT           7
#define RESOURCE_BUS                    8
#define RESOURCE_DRIVER                 9
