...
struct vfs_protocol
{
    ...
    unsigned int (*open)(struct vfs_backend *backend, struct task *task, unsigned int descriptor, unsigned int id);
    unsigned int (*close)(struct vfs_backend *backend, struct task *task, unsigned int descriptor, unsigned int id);
    unsigned int (*read)(struct vfs_backend *backend, struct task *task, unsigned int descriptor, unsigned int id, unsigned int offset, unsigned int count, void *buffer);
    unsigned int (*write)(struct vfs_backend *backend, struct task *task, unsigned int descriptor, unsigned int id, unsigned int offset, unsigned int count, void *buffer);
