...
struct service_protocol
{
    ...
    unsigned int (*open)(struct service_link *link, unsigned int id);
    unsigned int (*close)(struct service_link *link, unsigned int id);
    unsigned int (*read)(struct service_link *link, unsigned int id, unsigned int current, void *buffer, unsigned int count, unsigned int offset);
    unsigned int (*write)(struct service_link *link, unsigned int id, unsigned int current, void *buffer, unsigned int count, unsigned int offset);
