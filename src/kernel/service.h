...
struct service_protocol
{
    ...
    unsigned int (*read)(struct service_backend *backend, struct service_state *state, unsigned int id, void *buffer, unsigned int count, unsigned int offset);
    unsigned int (*write)(struct service_backend *backend, struct service_state *state, unsigned int id, void *buffer, unsigned int count, unsigned int offset);
