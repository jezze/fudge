...
static void setupmmap(void)
{
    ...
    mapentry(ARCH_MMU_KERNELBASE, ARCH_MMAP_BASE, mmap_allocate(header, MMAP_TYPE_NORMAL, ARCH_SMP_BASE16, ARCH_SMP_BASE16, 0x00001000, MMAP_FLAG_GLOBAL | MMAP_FLAG_WRITEABLE));
    mapentry(ARCH_MMU_KERNELBASE, ARCH_MMAP_BASE, mmap_allocate(header, MMAP_TYPE_NORMAL, 0x00010000, 0x00010000, 0x00001000, MMAP_FLAG_GLOBAL | MMAP_FLAG_WRITEABLE));
