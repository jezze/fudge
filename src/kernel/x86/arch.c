...
static void setupmmap(void)
{
    ...
    mapentry(ARCH_MMU_KERNELBASE, ARCH_MMAP_BASE, mmap_allocate(header, MMAP_TYPE_NORMAL, 0x000B8000, 0x000B8000, 0x00008000, MMAP_FLAG_GLOBAL | MMAP_FLAG_WRITEABLE));
