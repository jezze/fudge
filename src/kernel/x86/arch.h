...
#define ARCH_KERNELMMUPHYSICAL          0x00400000
#define ARCH_KERNELSTACKPHYSICAL        0x00480000
#define ARCH_KERNELSTACKSIZE            0x00008000
#define ARCH_MAILBOXPHYSICAL            0x00500000
#define ARCH_MAILBOXSIZE                0x00001000
#define ARCH_TASKMMUPHYSICAL            0x00700000
