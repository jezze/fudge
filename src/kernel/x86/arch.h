...
#define ARCH_MAILBOXADDRESS             0x00800000
#define ARCH_MAILBOXSIZE                0x00001000
#define ARCH_MMUKERNELADDRESS           0x00900000
#define ARCH_MMUTASKADDRESS             0x00A00000
#define ARCH_MMUTASKSIZE                0x00004000
#define ARCH_TASKCODEADDRESS            0x04000000
