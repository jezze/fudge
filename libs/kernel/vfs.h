...
struct vfs_protocol
{
    ...
    unsigned int (*open)(struct vfs_backend *backend, unsigned int id, enum vfs_state *state);
    unsigned int (*close)(struct vfs_backend *backend, unsigned int id, enum vfs_state *state);
