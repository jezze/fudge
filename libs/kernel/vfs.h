...
struct vfs_protocol
{
    ...
    unsigned int (*open)(struct vfs_backend *backend, unsigned int id, struct vfs_mode *mode);
    unsigned int (*close)(struct vfs_backend *backend, unsigned int id, struct vfs_mode *mode);
