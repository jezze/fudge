...
static void setup(struct vfs_backend *backend, struct vfs_protocol *vprotocol, struct binary_protocol *bprotocol, unsigned int id)
{
    ...
    task.registers.ip = bprotocol->copy_program(vprotocol, backend, id);
