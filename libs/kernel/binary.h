struct binary_protocol
{
    ...
    unsigned long (*find_symbol)(struct vfs_session *session, unsigned int id, unsigned int count, const char *symbol);
    unsigned long (*copy_program)(struct vfs_session *session, unsigned int id);
