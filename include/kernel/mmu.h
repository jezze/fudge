...
extern void mmu_unit_init(struct mmu_unit *unit, void (*load_memory)(struct mmu_memory *memory), void (*map_kernel_memory)(struct mmu_memory *memory), void (*map_user_memory)(struct mmu_memory *memory), void (*unmap_memory)(struct mmu_memory *memory));
