...
struct kernel_arch
{
    ...
    void (*map_task_memory)(void *paddress, void *vaddress, unsigned int size, unsigned int tableFlags, unsigned int pageFlags);
...
extern void kernel_map_task_memory(void *paddress, void *vaddress, unsigned int size, unsigned int tableFlags, unsigned int pageFlags);
