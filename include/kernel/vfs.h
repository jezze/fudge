...
extern void vfs_filesystem_init(struct vfs_filesystem *filesystem, struct vfs_node *(*get_node)(struct vfs_filesystem *self, unsigned int index), struct vfs_node *(*find_node)(struct vfs_filesystem *self, char *name), struct vfs_node *(*walk)(struct vfs_filesystem *self, unsigned int index));
