...
extern void vfs_view_init(struct vfs_view *view, char *name, struct vfs_node *(*find_node)(struct vfs_view *self, char *name));
...
extern void vfs_filesystem_init(struct vfs_filesystem *filesystem, struct vfs_node *root, struct vfs_node *(*find_node)(struct vfs_filesystem *self, char *view, char *name), struct vfs_view *(find_view)(struct vfs_filesystem *self, char *name));
