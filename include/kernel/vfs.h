...
struct vfs_filesystem
{
    ...
    struct vfs_view *views[8];
    void (*add_view)(struct vfs_filesystem *self, struct vfs_view *view);
    struct vfs_view *(*find_view)(struct vfs_filesystem *self, char *name);
    struct vfs_node *(*lookup)(struct vfs_filesystem *self, char *view, char *name);
...
extern void vfs_view_init(struct vfs_view *view, char *name);
...
extern void vfs_filesystem_init(struct vfs_filesystem *filesystem, struct vfs_node *root, struct vfs_node *(*lookup)(struct vfs_filesystem *self, char *view, char *name));
