...
extern struct elf_program_header *elf_get_program_header(void *address, struct elf_header *header);
extern struct elf_section_header *elf_get_section_header_by_index(void *address, struct elf_header *header, unsigned int index);
