...
#define I915_DPLL_CONTROL_VGA_DIV4              (0x08 << 16)
#define I915_DPLL_CONTROL_VGA_DIV5              (0x10 << 16)
#define I915_DPLL_CONTROL_VGA_DIV6              (0x20 << 16)
#define I915_DPLL_CONTROL_VGA_DIV7              (0x30 << 16)
#define I915_DPLL_CONTROL_VGA_DIV8              (0x40 << 16)
#define I915_DPLL_CONTROL_MODE0_DIV5            (0x01 << 24)
#define I915_DPLL_CONTROL_MODE0_DIV10           (0x02 << 24)
#define I915_DPLL_CONTROL_MODE1_DIV7            (0x01 << 24)
#define I915_DPLL_CONTROL_MODE1_DIV14           (0x02 << 24)
#define I915_DPLL_CONTROL_MODE0                 (0x01 << 26)
#define I915_DPLL_CONTROL_MODE1                 (0x01 << 27)
#define I915_DPLL_CONTROL_DISABLE_VGA           (0x01 << 28)
#define I915_DPLL_CONTROL_ENABLE_VCO            (0x01 << 31)

#define I915_DISPLAY_CONTROL_8BPP               (0x02 << 26)
#define I915_DISPLAY_CONTROL_16BPP              (0x05 << 26)
#define I915_DISPLAY_CONTROL_32BPP              (0x07 << 26)
#define I915_DISPLAY_CONTROL_ENABLE_GAMMA       (0x01 << 30)
#define I915_DISPLAY_CONTROL_ENABLE_PLANE       (0x01 << 31)

#define I915_PIPE_CONFIG_STATE                  (0x01 << 30)
#define I915_PIPE_CONFIG_ENABLE                 (0x01 << 31)

#define I915_PIPE_STATUS_VBLANK                 (0x01 << 1)
#define I915_PIPE_STATUS_VSYNC                  (0x01 << 9)
