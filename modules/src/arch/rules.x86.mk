...
MODULES_MULTI=modules/src/arch/x86/multi/multi.ko
...
MODULES_OBJECTS_APIC=modules/src/arch/x86/apic/main.o modules/src/arch/x86/apic/apic.o
...
MODULES_OBJECTS_MULTI=modules/src/arch/x86/multi/main.o
...
MODULES_OBJECTS_PS2=modules/src/arch/x86/ps2/main.o modules/src/arch/x86/ps2/device.o modules/src/arch/x86/ps2/kbd_driver.o modules/src/arch/x86/ps2/mouse_driver.o
...
MODULES+=$(MODULES_ACPI) $(MODULES_APIC) $(MODULES_ATA) $(MODULES_BGA) $(MODULES_CPUID) $(MODULES_FPU) $(MODULES_I915) $(MODULES_IO) $(MODULES_MSR) $(MODULES_MULTI) $(MODULES_PCI) $(MODULES_PIT) $(MODULES_PS2) $(MODULES_RTC) $(MODULES_RTL8139) $(MODULES_SMP) $(MODULES_UART) $(MODULES_VGA)
MODULES_OBJECTS+=$(MODULES_OBJECTS_ACPI) $(MODULES_OBJECTS_APIC) $(MODULES_OBJECTS_ATA) $(MODULES_OBJECTS_BGA) $(MODULES_OBJECTS_CPUID) $(MODULES_OBJECTS_FPU) $(MODULES_OBJECTS_I915) $(MODULES_OBJECTS_IO) $(MODULES_OBJECTS_MSR) $(MODULES_OBJECTS_MULTI) $(MODULES_OBJECTS_PCI) $(MODULES_OBJECTS_PIT) $(MODULES_OBJECTS_PS2) $(MODULES_OBJECTS_RTC) $(MODULES_OBJECTS_RTL8139) $(MODULES_OBJECTS_SMP) $(MODULES_OBJECTS_UART) $(MODULES_OBJECTS_VGA)
