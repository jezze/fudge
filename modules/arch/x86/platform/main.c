...
void init()
{
    ...
    platform_init_device(&uart1, PLATFORM_UART_DEVICE_TYPE, "uart0", &bus, 0x03F8);
    platform_init_device(&uart2, PLATFORM_UART_DEVICE_TYPE, "uart1", &bus, 0x02F8);
    platform_init_device(&uart3, PLATFORM_UART_DEVICE_TYPE, "uart2", &bus, 0x03E8);
    platform_init_device(&uart4, PLATFORM_UART_DEVICE_TYPE, "uart3", &bus, 0x02E8);
