...
void vga_settext()
{
    ...
    io_outw(0x3D4, 0x0D0A);
    io_outw(0x3D4, 0x0E0B);
    io_outw(0x3D4, 0x000C);
    io_outw(0x3D4, 0x000D);
    io_outw(0x3D4, 0x000E); /* 000E, 010E, 020E, 030E? */
    io_outw(0x3D4, 0x500F); /* 500F, 820F, 920F, 940F, C00F? */
    io_outw(0x3D4, 0x9C10);
    io_outw(0x3D4, 0x0E11); /* 0E11, 8E11? */
    ...
    io_outw(0x3CE, 0x0007); /* 0007, 0F07? */
