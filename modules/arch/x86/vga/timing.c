...
void vga_settext()
{
    ...
    io_outw(0x3D4, 0x000A);
    io_outw(0x3D4, 0x000B);
    io_outw(0x3D4, 0x000C);
    io_outw(0x3D4, 0x000D);
    io_outw(0x3D4, 0x000E);
    io_outw(0x3D4, 0x000F);
    ...
    io_outb(0x3C0, 0x00 | 0x00);
    io_outb(0x3C0, 0x00);
    io_outb(0x3C0, 0x00 | 0x01);
    io_outb(0x3C0, 0x01);
    io_outb(0x3C0, 0x00 | 0x02);
    io_outb(0x3C0, 0x02);
    io_outb(0x3C0, 0x00 | 0x03);
    io_outb(0x3C0, 0x03);
    io_outb(0x3C0, 0x00 | 0x04);
    io_outb(0x3C0, 0x04);
    io_outb(0x3C0, 0x00 | 0x05);
    io_outb(0x3C0, 0x05);
    io_outb(0x3C0, 0x00 | 0x06);
    io_outb(0x3C0, 0x06);
    io_outb(0x3C0, 0x00 | 0x07);
    io_outb(0x3C0, 0x07);
    io_outb(0x3C0, 0x00 | 0x08);
    io_outb(0x3C0, 0x08);
    io_outb(0x3C0, 0x00 | 0x09);
    io_outb(0x3C0, 0x09);
    io_outb(0x3C0, 0x00 | 0x0A);
    io_outb(0x3C0, 0x0A);
    io_outb(0x3C0, 0x00 | 0x0B);
    io_outb(0x3C0, 0x0B);
    io_outb(0x3C0, 0x00 | 0x0C);
    io_outb(0x3C0, 0x0C);
    io_outb(0x3C0, 0x00 | 0x0D);
    io_outb(0x3C0, 0x0D);
    io_outb(0x3C0, 0x00 | 0x0E);
    io_outb(0x3C0, 0x0E);
    io_outb(0x3C0, 0x00 | 0x0F);
    io_outb(0x3C0, 0x0F);
