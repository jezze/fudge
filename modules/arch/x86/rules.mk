...
MODULES+=$(MODULES_ACPI)
MODULES+=$(MODULES_APIC)
MODULES+=$(MODULES_ATA)
MODULES+=$(MODULES_BGA)
MODULES+=$(MODULES_CPUID)
MODULES+=$(MODULES_FPU)
MODULES+=$(MODULES_I915)
MODULES+=$(MODULES_IO)
MODULES+=$(MODULES_MSR)
MODULES+=$(MODULES_MULTI)
MODULES+=$(MODULES_PCI)
MODULES+=$(MODULES_PIC)
MODULES+=$(MODULES_PIT)
MODULES+=$(MODULES_PS2)
MODULES+=$(MODULES_RTC)
MODULES+=$(MODULES_RTL8139)
MODULES+=$(MODULES_SMP)
MODULES+=$(MODULES_UART)
MODULES+=$(MODULES_VGA)

MODULES_OBJECTS+=$(MODULES_OBJECTS_ACPI)
MODULES_OBJECTS+=$(MODULES_OBJECTS_APIC)
MODULES_OBJECTS+=$(MODULES_OBJECTS_ATA)
MODULES_OBJECTS+=$(MODULES_OBJECTS_BGA)
MODULES_OBJECTS+=$(MODULES_OBJECTS_CPUID)
MODULES_OBJECTS+=$(MODULES_OBJECTS_FPU)
MODULES_OBJECTS+=$(MODULES_OBJECTS_I915)
MODULES_OBJECTS+=$(MODULES_OBJECTS_IO)
MODULES_OBJECTS+=$(MODULES_OBJECTS_MSR)
MODULES_OBJECTS+=$(MODULES_OBJECTS_MULTI)
MODULES_OBJECTS+=$(MODULES_OBJECTS_PCI)
MODULES_OBJECTS+=$(MODULES_OBJECTS_PIC)
MODULES_OBJECTS+=$(MODULES_OBJECTS_PIT)
MODULES_OBJECTS+=$(MODULES_OBJECTS_PS2)
MODULES_OBJECTS+=$(MODULES_OBJECTS_RTC)
MODULES_OBJECTS+=$(MODULES_OBJECTS_RTL8139)
MODULES_OBJECTS+=$(MODULES_OBJECTS_SMP)
MODULES_OBJECTS+=$(MODULES_OBJECTS_UART)
MODULES_OBJECTS+=$(MODULES_OBJECTS_VGA)
