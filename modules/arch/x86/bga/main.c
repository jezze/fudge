...
static void attach(struct base_device *device)
{
    ...
    bank = (void *)0xA0000;
    lfb = (void *)(unsigned long)pci_bus_ind(pciBus, pciDevice->address, PCI_CONFIG_BAR0);
...
static unsigned int check(struct base_device *device)
{
    ...
    return pci_bus_inw(pciBus, pciDevice->address, PCI_CONFIG_VENDOR) == BGA_PCI_VENDOR && pci_bus_inw(pciBus, pciDevice->address, PCI_CONFIG_DEVICE) == BGA_PCI_DEVICE;
