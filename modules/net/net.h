struct net_protocol
{
    ...
    char *name;
    unsigned int (*read)(struct base_network *interface, unsigned int offset, unsigned int count, void *buffer);
    unsigned int (*write)(struct base_network *interface, unsigned int offset, unsigned int count, void *buffer);
