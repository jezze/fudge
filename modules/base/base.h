...
struct base_driver
{
    ...
    struct resource resource;
    const char *name;
    void (*init)(struct base_driver *self);
    unsigned int (*match)(struct base_driver *self, struct base_bus *bus, unsigned int id);
    void (*attach)(struct base_driver *self, struct base_bus *bus, unsigned int id);
    void (*detach)(struct base_driver *self, struct base_bus *bus, unsigned int id);
