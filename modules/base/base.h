...
struct base_driver
{
    ...
    struct resource resource;
    const char *name;
    unsigned int (*check)(struct base_bus *bus, struct base_device *device);
    void (*attach)(struct base_bus *bus, struct base_device *device);
    void (*detach)(struct base_bus *bus, struct base_device *device);
