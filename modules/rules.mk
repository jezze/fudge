...
MODULES_TCP=modules/src/tcp/tcp.ko
...
MODULES_OBJECTS_TCP=modules/src/tcp/main.o modules/src/tcp/protocol.o
...
MODULES+=$(MODULES_BASE) $(MODULES_BLOCK) $(MODULES_EXT2) $(MODULES_NET) $(MODULES_NODEFS) $(MODULES_TCP) $(MODULES_TTY) $(MODULES_VIDEO)
MODULES_OBJECTS+=$(MODULES_OBJECTS_BASE) $(MODULES_OBJECTS_BLOCK) $(MODULES_OBJECTS_EXT2) $(MODULES_OBJECTS_NET) $(MODULES_OBJECTS_NODEFS) $(MODULES_OBJECTS_TCP) $(MODULES_OBJECTS_TTY) $(MODULES_OBJECTS_VIDEO)
...
$(MODULES_TCP): lib/src/memory.o lib/src/string.o $(MODULES_OBJECTS_TCP)
	$(LD) $(LDFLAGS) -o $@ $^
