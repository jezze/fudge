...
MODULES_OBJECTS_BLOCK=modules/src/block/main.o modules/src/block/driver.o modules/src/block/filesystem.o
...
MODULES+=$(MODULES_BLOCK) $(MODULES_EXT2) $(MODULES_LOG) $(MODULES_MBR) $(MODULES_NET) $(MODULES_NODEFS) $(MODULES_TTY)
MODULES_OBJECTS+=$(MODULES_OBJECTS_BLOCK) $(MODULES_OBJECTS_EXT2) $(MODULES_OBJECTS_LOG) $(MODULES_OBJECTS_MBR) $(MODULES_OBJECTS_NET) $(MODULES_OBJECTS_NODEFS) $(MODULES_OBJECTS_TTY)
