...
MODULES_MODULES=modules/src/modules/modules.ko
...
MODULES+=$(MODULES_BLOCK) $(MODULES_EXT2) $(MODULES_MODULES) $(MODULES_NET) $(MODULES_NODEFS) $(MODULES_TTY) $(MODULES_VIDEO)
MODULES_OBJECTS+=$(MODULES_OBJECTS_BLOCK) $(MODULES_OBJECTS_EXT2) $(MODULES_OBJECTS_MODULES) $(MODULES_OBJECTS_NET) $(MODULES_OBJECTS_NODEFS) $(MODULES_OBJECTS_TTY) $(MODULES_OBJECTS_VIDEO)
...
$(MODULES_MODULES): lib/src/memory.o lib/src/string.o $(MODULES_OBJECTS_MODULES)
	$(LD) $(LDFLAGS) -o $@ $^
