struct video_interface
{
    ...
    unsigned int xres;
    unsigned int yres;
    void (*mode)(struct video_interface *self);
    ...
    unsigned int (*read_colormap)(struct video_interface *self, unsigned int offset, unsigned int count, void *buffer);
    unsigned int (*write_colormap)(struct video_interface *self, unsigned int offset, unsigned int count, void *buffer);
