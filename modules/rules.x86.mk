...
MODULES_PIC=modules/src/arch/x86/pic/pic.ko
...
MODULES_OBJECTS_PIC=modules/src/arch/x86/pic/main.o modules/src/arch/x86/pic/pic.o
...
$(MODULES_PIC): lib/src/memory.o lib/src/string.o $(MODULES_OBJECTS_PIC)
	$(LD) $(LDFLAGS) -o $@ $^
