...
#define EVENT_VIDEOCMAP                 0x18
#define EVENT_VIDEOCONF                 0x19
#define EVENT_VIDEOINFO                 0x1A
#define EVENT_BLOCKREQUEST              0x1B
#define EVENT_BLOCKRESPONSE             0x1C
#define EVENT_CLOCKINFO                 0x1D
#define EVENT_ETHERNETINFO              0x1E
