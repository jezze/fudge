...
void set_xres(unsigned int xres)
{
    ...
    call_open(3, 16, "/module/bga/xres");
...
void set_yres(unsigned int yres)
{
    ...
    call_open(3, 16, "/module/bga/yres");
...
void enable()
{
    ...
    call_open(3, 18, "/module/bga/enable");
...
void main()
{
    ...
    idlfb = call_open(4, 15, "/module/bga/lfb");

    if (!idlfb)
        return;

    idmcycle = call_open(5, 18, "/module/ps2/mcycle");
    idmstatus = call_open(6, 19, "/module/ps2/mstatus");
    idmx = call_open(7, 14, "/module/ps2/mx");
    idmy = call_open(8, 14, "/module/ps2/my");
